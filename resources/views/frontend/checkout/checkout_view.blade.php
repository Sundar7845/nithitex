                                    ...
                                    <div class="pay-top sin-payment sin-payment-3">
                                        ...
                                        <div class="payment-box payment_method_bacs online hidden">
                                            <input type="hidden" name="hdShipping_online" id="hdShipping_online"
                                                value="0">
                                            <p>FOR ONLINE PAYMENT THE SHIPPING COST IS <span id="shipping_online"
                                                    class="text-danger"
                                                    style="font-weight:bolder">{{ $shipping_charge }}</span></p>
                                        </div>
                                    </div>
                                    <div class="pay-top sin-payment">
                                        ...
                                        <div class="payment-box payment_method_bacs cod hidden">
                                            <input type="hidden" name="hdShipping_cod" id="hdShipping_cod"
                                                value="0">
                                            <p>We are giving correct market price but if the payment is in Cash on
                                            ...
                                            <span id="shipping_cod" class="text-danger"
                                                style="font-weight:bolder">{{ $cod_charge }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    function bindShippingCost() {
        ...
        var netTotal = 0;
        var discountage_percentage = $("#hddiscount").val();
