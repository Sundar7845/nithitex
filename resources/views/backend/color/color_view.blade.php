                        ...
                        <div id="divColor" class="col-lg-4 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="code" name="code" class="form-control  @error('code') is-invalid @enderror"
                                    title="Please Enter Color Code" placeholder="Enter Color Code" required/>
                                    @error('code') 
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror 
                            </div>
                            ...
                            <table id="dataTableExample" class="table table-bordered">
                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td>
                                            <a href="{{ route('color.edit',$item->id) }}" class="btn btn-info btn-sm btn-flat" title="Edit Data">Edit</a>
                                            <a href="{{ route('color.delete',$item->id) }}" class="btn btn-danger btn-sm btn-flat" title="Delete Data" id="delete">Delete</a>
                                        </td>
                                    </tr>
                                    @php
                                        $serialNo++;
