...
<div class="page-content">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h5>Reseller Pending Order List </h5>
            </div>
            <div class="col-sm-6">
                            ...
                            <table id="dataTableExample" class="table table-bordered">
                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td><a href="{{ route('seller.pending.order.approve',$item->id) }}" class="btn btn-info" title="Approve"><i class="fa fa-eye"></i> Ready To Confirm</a>
                                        </td>        
                                    </tr>
                                    @php
                                        $serialNo++;
