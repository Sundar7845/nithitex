                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td>
                                            ...
                                            <a class="badge badge-pill badge-success text-white" href="{{ route('order.unpaid_status.update',$item->id) }}"> Paid </a>
                                            @else
                                        ...
                                        <td><a href="{{ route('pending.order.approve',$item->id) }}" class="btn btn-info" title="Edit Data"><i class="fa fa-eye"></i> Ready To Confirm</a>
                                        </td>        
                                    </tr>
                                    @php
                                        $serialNo++;
