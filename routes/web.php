...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::post('/reseller/coupon/update', [\App\Http\Controllers\Backend\SellerApproveController::class, 'sellerCouponUpdate'])->name('sellerCouponUpdate');
    ...
    Route::prefix('settings')->group(function () {
        ...
        //Coupon
        Route::get('coupon', [\App\Http\Controllers\Backend\CouponController::class, 'coupon'])->name('coupon.all');
        ...
        Route::post('coupon/update', [\App\Http\Controllers\Backend\CouponController::class, 'couponUpdate'])->name('coupon.update');
        Route::post('coupon/update/status', [\App\Http\Controllers\Backend\CouponController::class, 'couponUpdateStatus'])->name('coupon.status');
        Route::post('coupon/update/common/status', [\App\Http\Controllers\Backend\CouponController::class, 'couponUpdateCommonStatus'])->name('coupon.common');
    });
    //user-order-list
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/sellerreturn/reject/{order_id}', [\App\Http\Controllers\Backend\ReturnController::class, 'sellerReturnRequestReject'])->name('seller.return.reject');
    });
...
Route::group(['prefix' => 'staff', 'middleware' => ['auth:admin']], function () {
    Route::get('/staff/allstaffs', [\App\Http\Controllers\Backend\Staff\StaffController::class, 'staffView'])->name('all.staffs');
    Route::get('allorders', [\App\Http\Controllers\Backend\Staff\StaffController::class, 'staffOrderView'])->name('staff.order.all');
    Route::get('/unpaid_status/update/{order_id}', [\App\Http\Controllers\Backend\Staff\StaffController::class, 'paymentUnpaid'])->name('staff_order.unpaid_status.update');
    Route::get('/paid_status/update/{order_id}', [\App\Http\Controllers\Backend\Staff\StaffController::class, 'paymentPaid'])->name('staff_order.paid_status.update');
    Route::get('orderdetails/{order_id}', [\App\Http\Controllers\Backend\Staff\StaffController::class, 'staffOrdersDetails'])->name('stafforder.details');
    Route::post('order/update',  [\App\Http\Controllers\Backend\Staff\StaffController::class, 'staffOrderStatusUpdate'])->name('stafforder.update');
});
// ======================  STAFF ROUTES END ================================ //