...
class IndexController extends Controller
{
	...
	public function index()
	{
		...
		if (Auth::user()) {
			return view((Auth::user()->userrole_id == 1 ? 'frontend.index' : 'seller.index'), compact('category', 'is_featured', 'newarrivals', 'best_selling_products', 'about', 'sellerSlider', 'shopInformation'));
		} else {
