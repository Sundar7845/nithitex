                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><label for="">
                                                                ...
                                                                <div class="text-muted bg-light">
                                                                    <small>{{ $item->product->product_sku }}</small>
                                                                </div>
                                                            </td>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4" style="float-right;">
                                            @if ($order->status != 'delivered' && $order->status != 'returned')
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <span class="badge badge-pill badge-warning"
                                                            style="background: red">You Have sent cancel request for this
                                                            product</span>
                                                    @endif
                                                @endif
                                            @else
                                                ...
                                                @else
                                                    ...
                                                    @elseif(!$reject)
                                                        <span class="badge badge-pill badge-warning"
                                                            style="background: red">You Have send return request for this
                                                            product</span>
                                                    @endif
                                                @endif
                                            @endif
