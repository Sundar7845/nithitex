            ...
            <div class="col-lg-6 col-md-6">
                <div class="product-details-content pro-details-content-mrg">
                    ...
                    <div class="pro-details-price">
                        ...
                        <span class="old-price">₹{{ round($product_details->product_price) }}</span>
                    </div>
                    @if ($seller_url != '')
                        <div>
                    ...
                    <div class="offer">
                        ...
                        @else
                            ...
                            <strong>Discount Percentage : </strong><span
                                style="color:red; font-weight:bolder;font-size:15px;">{{ round($discount) }}%</span>
                        @endif
                    </div>
                    @if ($product_details->color)
                        <div class="pro-details-color-wrap"><br>
                            ...
                            <div class="pro-details-color-content">
                                <ul>
                                    <li><a style="background-color: {{ $product_details->color->color_code }};"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="pro-details-quality">
                        ...
                        <span>Available Quantity: {{ $product_details->current_stock }}</span>
                    </div>
                    <div class="pro-details-quality">
                    ...
                    <div class="pro-details-action-wrap">
                        <div class="pro-details-add-to-cart">
                            <button type="submit" class="btn btn-flat btn-dark" title="Add to Cart"
                        ...
                        <div class="pro-details-action">
                            <a title="Add to Wishlist"><i
                                    class="@if (isset($product_details->is_favourite)) fa-solid fa-heart heart @else icon-heart @endif"
                                    id="{{ $product_details->id }}" onclick="addToWishList(this.id)"></i></a>
                ...
                <div class="product-plr-1">
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a
                                href="{{ url(($seller_url == '' ? '' : $seller_url) . 'product/details/' . $related_product->id . '/' . $related_product->product_slug) }}">
                        ...
                        <div class="product-content-wrap-2 product-content-position text-center">
                            ...
                            <div class="pro-add-to-cart">
                                ...
                                <button title="Add to Cart" type="submit" id="{{ $related_product->id }}"
                                    onclick="addToCartsimple(this.id)">Add To Cart</button>
                                <a href="{{ url(($seller_url == '' ? '' : $seller_url) . 'product/buynow/' . $related_product->id) }}"
