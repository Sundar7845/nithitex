                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $user = App\Models\User::where('userrole_id', 1)
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $allorders = App\Models\Order::where('userrole_id', 1)
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $seller = App\Models\Seller::where('is_verified', 1)
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $pendingrequest = App\Models\seller::where('is_verified', 0)
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $sellerallorders = App\Models\Order::where('userrole_id', 2)
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @php
                                $staffpendingorders = App\Models\StaffOrder::where('status', 'pending')
                                    ->get()
                                    ->count();
                            @endphp
                            <div class="row">
