...
<div class="page-content">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h5>Reseller Confirmed Order List </h5>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active">Master</li>
                <li class="breadcrumb-item active">Reseller Confirmed Order List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                            ...
                            <table id="dataTableExample" class="table table-bordered">
                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td>
                                            <a href="{{ route('seller.confirmed.order.approve',$item->id) }}" class="btn btn-info" title="Edit Data"><i class="fa fa-eye"></i> Move To Processing</a>
                                        </td>        
                                    </tr>
                                    @php
                                        $serialNo++;
